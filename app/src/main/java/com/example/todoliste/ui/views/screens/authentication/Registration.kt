package com.example.todoliste.ui.views.screens.authentication
...
import com.example.todoliste.ui.components.DefaultCheckbox
import com.example.todoliste.ui.components.DefaultTextField
import com.example.todoliste.ui.theme.TodolisteTheme
import com.example.todoliste.ui.views.AuthRouteScreens
import com.example.todoliste.ui.views.layout.BackTopAppBar
import com.example.todoliste.utils.StringConstants
import com.example.todoliste.utils.emailLengthValidation
import com.example.todoliste.utils.fullNameLengthValidation
import com.example.todoliste.utils.passwordLengthValidation
import com.example.todoliste.viewmodels.AuthViewModel
                                    ...
                                    if (!isTermsAccepted) {
                                        ...
                                        if (authState.usersList.isNotEmpty()) {
                                            ...
                                            authViewModel.sendOTPCode(
                                                com.example.todoliste.data.room.models.OTPCode(
                                                    email = email,
